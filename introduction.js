...
const dataTypes = [ "Numbers", "Strings", "Boolean", "BigINT", "Object", "Symblol", "undefined", "null" ]
...
function Car(name, model, company, fuelAvg) {
  ...
  this.Details = function () {
    console.log(this);    
    console.log(`${this.name} ${this.model} of ${this.company} has fuel Average of ${this.fuelAvg}`);
  }
}
...
class Person {
  ...
  get details() {
    console.log(`Hi Mr.${this.firstName} ${this.lastName}. Your Age is ${this.Age} and profession is ${this.profession}. Nationality: ${this.nationality}`)
  }
}

class Teacher extends Person {
  constructor(firstName, lastName, Age, profession, subject, grade, noOfStudents){
  ...
  get details(){
    super.details;
    console.log(`Your Subject is: ${this.subject} and your teaching grade is ${this.grade}. Your are currently monitering ${this.noOfStudents} students`);
  }
}
